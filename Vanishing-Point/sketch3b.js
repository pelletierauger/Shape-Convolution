...
let fileName = "/Volumes/Volumina/frames/shape-convolution/vanishing-point-flip-slow/sketch";
...
function draw() {
    ...
    for (let i = 0; i < shape.length; i += 1) {
        ...
        if (intersection !== null) {
            ...
            line(shape[i].x * (1 + sc), shape[i].y + 0.75,
                shape[i].x * (1 + sc), intersection.y - 0.75);
            // stroke(0);
            // for (let k = 0; k < 50; k++) {
            //   let sc = i / 20;
